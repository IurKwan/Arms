...
open class DefaultPlaylistNotificationProvider(protected val context: Context) : PlaylistNotificationProvider {
    ...
    protected open fun buildMediaStyle(mediaSession: MediaSessionCompat, serviceClass: Class<out Service>) : androidx.media.app.NotificationCompat.MediaStyle {
        return with(androidx.media.app.NotificationCompat.MediaStyle()) {
