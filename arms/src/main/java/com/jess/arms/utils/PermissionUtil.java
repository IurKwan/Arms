...
public class PermissionUtil {
    ...
    public static void location(RequestPermission requestPermission, RxPermissions rxPermissions) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            requestPermission(requestPermission, rxPermissions, Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_BACKGROUND_LOCATION);
        } else {
            requestPermission(requestPermission, rxPermissions, Manifest.permission.ACCESS_FINE_LOCATION);
        }
    }
}
